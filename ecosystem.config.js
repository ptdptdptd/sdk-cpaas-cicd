...
module.exports = {
  apps: [{
    ...
    env: {
      ...
      LOGLEVEL: 'debug',
      HTTP_PORT: 3000,
      JAMBONZ_ACCOUNT_SID: 'fd72941c-773d-4c5f-b128-5eaa469e83fe',
      JAMBONZ_API_KEY: 'd172c5e7-9cc4-4743-80cc-59313057bf7a',
      JAMBONZ_REST_API_BASE_URL: 'http://sbc.servertesing.tk:3000/v1',
      WEBHOOK_SECRET: 'wh_secret_szJE4ZXCyuZyejHECsJ3W8',
